  ...
  <div id="mobile-nav" class="fixed inset-0 z-40 hidden">
    ...
    <div class="relative mx-auto max-w-sm px-4 pt-20">
      <div id="mobile-panel" class="rounded-2xl border border-white/10 bg-zinc-950/80 ring-1 ring-white/10 divide-y divide-white/10 opacity-0 translate-y-2 transition-all duration-300 shadow-2xl shadow-black/60" style="transform: translateZ(0);">
        <div class="p-4">
          <a href="https://media.dhyey.cc/" class="group inline-flex items-center gap-3 focus:outline-none focus:ring-2 focus:ring-orange-300/30 rounded-xl">
            <img src="https://media.dhyey.cc/favicon.ico" alt="Commonthread Logo" class="h-8 w-8 rounded-full ring-1 ring-white/10">
    ...
    <div class="mx-auto max-w-7xl px-4 py-6 md:px-6">
      <div class="flex flex-col items-center gap-3">
        <p class="text-sm text-zinc-400 text-center">
          ...
          <a href="https://media.dhyey.cc" target="_blank" class="text-orange-200 hover:text-orange-100 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-orange-300/30 rounded">
            Commonthread
          </a>.
        </p>

        <div class="inline-flex items-center gap-4">
          <a href="https://media.dhyey.cc" target="_blank" aria-label="Telegram Channel" class="inline-flex h-9 w-9 items-center justify-center rounded-xl ring-1 ring-white/10 hover:ring-orange-300/30 hover:text-orange-200 transition-colors focus:outline-none focus:ring-2 focus:ring-orange-300/30 bg-white/[0.02]">
            <span class="iconify h-5 w-5" data-icon="lucide:send" data-inline="false"></span>
          </a>

          <a href="https://github.com/commonthread" target="_blank" aria-label="GitHub Profile" class="inline-flex h-9 w-9 items-center justify-center rounded-xl ring-1 ring-white/10 hover:ring-orange-300/30 hover:text-orange-200 transition-colors focus:outline-none focus:ring-2 focus:ring-orange-300/30 bg-white/[0.02]">
...
async function handleRootRequest(request, USERNAME, PASSWORD, enableAuth) {
  ...
  <head>
    ...
    <meta property="og:image" content="https://raw.githubusercontent.com/commonthread/TG-MediaHost-Bot/main/Images/commonthread.png">
    ...
    <meta name="twitter:image" content="https://raw.githubusercontent.com/commonthread/TG-MediaHost-Bot/main/Images/commonthread.png">
    <title>Commonthread - Fast & Secure Media Hosting</title>
    <link rel="icon" href="https://raw.githubusercontent.com/commonthread/TG-MediaHost-Bot/main/Images/commonthread.png" type="image/x-icon">
  ...
  <body class="min-h-screen antialiased selection:bg-indigo-500/30 selection:text-indigo-100 dark-mode">
      ...
      <section class="glass rounded-[14px] p-6 md:p-8">
        ...
        <footer class="pt-6 mt-6 border-t divider text-center animate-fadeIn" style="animation-delay: 0.2s;">
          ...
          <p class="text-slate-400 dark-mode:text-slate-500 text-sm">Made with ❤️ by -
            <a class="text-indigo-300 dark-mode:text-indigo-500 hover:text-indigo-200 dark-mode:hover:text-indigo-400 underline-offset-4 hover:underline transition-colors duration-300" href="https://media.dhyey.cc" target="_blank" rel="noopener noreferrer">Commonthread</a>
          </p>
        </footer>
      </section>
    </main>
    ...
    <!-- Contact form -->
    <script src="https://cdn.jsdelivr.net/gh/commonthread/contact@master/src/contact.min.js"
      id="contactform"
      error_text=""
      success_text=""
    ...
    <script>
      ...
      const backgroundImages = [
        "https://raw.githubusercontent.com/commonthread/TG-MediaHost-Bot/main/Images/1.webp",
        "https://raw.githubusercontent.com/commonthread/TG-MediaHost-Bot/main/Images/2.webp",
        "https://raw.githubusercontent.com/commonthread/TG-MediaHost-Bot/main/Images/3.webp",
        "https://raw.githubusercontent.com/commonthread/TG-MediaHost-Bot/main/Images/4.webp",
        "https://raw.githubusercontent.com/commonthread/TG-MediaHost-Bot/main/Images/5.webp"
      ];
